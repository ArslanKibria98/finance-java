 ...
 */
@Repository
public interface JpaSubCategoryRepository extends JpaRepository<SubCategoryJpaEntity, UUID> {

    List<SubCategoryJpaEntity> findAllByMasterCategoryIdAndTenantIdAndIsActiveTrue(
