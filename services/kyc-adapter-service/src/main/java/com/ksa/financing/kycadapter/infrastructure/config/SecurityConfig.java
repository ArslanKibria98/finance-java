...
/**
 * Security configuration for OAuth2/OIDC with Keycloak.
 *
 * Features:
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        return http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                // KYC endpoints — service-to-service calls from onboarding workflow activities
                // In production, these should be behind a service mesh with mTLS
