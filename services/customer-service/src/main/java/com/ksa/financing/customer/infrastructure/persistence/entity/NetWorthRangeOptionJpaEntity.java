...
@Entity
@Table(name = "net_worth_range_options")
@Getter
@Setter
// NOTE: Filename should be NetWorthRangeOptionJpaEntity.java - renamed class per naming conventions
public class NetWorthRangeOptionJpaEntity {
