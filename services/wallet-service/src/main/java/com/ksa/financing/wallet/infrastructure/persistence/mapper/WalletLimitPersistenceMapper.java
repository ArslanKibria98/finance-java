...
public class WalletLimitPersistenceMapper {
    ...
    public WalletLimitBoundsJpaEntity toEntity(WalletLimitBounds domain) {
        ...
        e.setMinWeeklyLimit(domain.getMinWeeklyLimit());
        e.setMaxWeeklyLimit(domain.getMaxWeeklyLimit());
        ...
        e.setDefaultWeeklyLimit(domain.getDefaultWeeklyLimit());
    ...
    public WalletLimitBounds toDomain(WalletLimitBoundsJpaEntity e) {
        ...
        d.setMinWeeklyLimit(e.getMinWeeklyLimit());
        d.setMaxWeeklyLimit(e.getMaxWeeklyLimit());
        ...
        d.setDefaultWeeklyLimit(e.getDefaultWeeklyLimit());
    ...
    public WalletLimitChangeRequestJpaEntity toEntity(WalletLimitChangeRequest domain) {
        ...
        e.setRequestedWeeklyLimit(domain.getRequestedWeeklyLimit());
        ...
        e.setCurrentWeeklyLimit(domain.getCurrentWeeklyLimit());
    ...
    public WalletLimitChangeRequest toDomain(WalletLimitChangeRequestJpaEntity e) {
        ...
        d.setRequestedWeeklyLimit(e.getRequestedWeeklyLimit());
        ...
        d.setCurrentWeeklyLimit(e.getCurrentWeeklyLimit());
