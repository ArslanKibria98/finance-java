-- ============================================================================
-- LMS CHART OF ACCOUNTS - Micro-Lending Platform Accounts
-- Extracted from external LMS system and inserted into ledger-service
-- ============================================================================
...
BEGIN
    ...
    VALUES
        ...
        -- Expense Accounts (14xxx, 16xxx series)
...
-- Verify insertion
SELECT 'LMS ACCOUNTS SUMMARY' AS info;
SELECT
    account_code,
    account_name,
    account_type,
...
WHERE tenant_id = '00000000-0000-0000-0000-000000000001'
  AND account_code IN ('110100', '110102', '110104', '110204', '110205', '110401', '110402',
